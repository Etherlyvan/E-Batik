...
const Gallery = () => {
    ...
    const filteredBatiks = batiks.filter((batik) => {
        ...
        return (
            matchesSearchTerm && matchesTema && matchesTahun && matchesTeknik
        );
    });
    ...
    const currentItems = filteredBatiks.slice(
        indexOfFirstItem,
        indexOfLastItem
    );
        ...
        <div className='min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100'>
            <div className='max-w-screen-2xl mx-auto py-16 px-4'>
                ...
                <div className='text-center mb-16'>
                    ...
                    >
                        Koleksi batik tradisional Indonesia yang menampilkan
                        keindahan dan keragaman budaya nusantara
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <div className='text-sm text-gray-500'>
                        ...
                        {Math.min(indexOfLastItem, filteredBatiks.length)} dari{' '}
                        {filteredBatiks.length} batik
                    </div>
                </motion.div>
                        ...
                        >
                            <div className='text-center bg-white p-8 rounded-xl shadow-sm max-w-md w-full'>
                                ...
                                <p className='text-gray-500 mb-6'>
                                    Belum ada data batik yang tersedia. Mulai
                                    tambahkan koleksi batik pertama Anda.
                                </p>
                                {user && <AddBatikButton />}
                            </div>
                        </motion.div>
