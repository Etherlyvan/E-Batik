      ...
      >
        ...
        <div className="mt-2 md:mt-10">
          <motion.h2 
            ...
            className="text-4xl md:text-6xl font-bold mb-6 leading-tight bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent whitespace-normal overflow-visible pb-4" // Menambahkan padding bawah
          >
